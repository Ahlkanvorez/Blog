(function () {
     ...
     * The 'title' attribute is the actual title displayed in the article-list and at the top of the article-view page.
     * The 'author' attribute encapsulates all information about the person who wrote the article, or the original
     * author from which the article has been copied/reformatted. The author should contain both a name and an email,
     * but if one is not appropriate it may be omitted.
     * The 'date' attribute represents the date the article was first created, and is the primary attribute on which the
     * article-list page sorts the articles.
     * (TODO: decide whether it should be the date last edited, first created, posted, or maybe even a history of edits)
     * The 'category' attribute is simply the name of the category to which the article belongs.
     * The 'content' attribute is a String of the raw HTML for the article, which is injected into the article-view
     * page.
     * The 'sticky' attribute, if true, indicates that the article is to be listed first (or alphabetically amongst the
     * other sticky articles) in the listing of articles of the same category. In the main page, sticky articles take
    ...
    /**
     * Searches for articles whose titles match the given pattern (regular expression).
     *
     * @param title The title or regex to match against the title, of the desired articles.
    ...
    /**
     * Searches for articles which belong to categories whose names match the given pattern (regular expression).
     *
     * @param category The name or regex to match against the name of the category, of the desired articles.
    ...
    /**
     * Searches for articles whose dates are between the provided two dates, [start, end), inclusive for start, and
     * exclusive for end.
     *
     * @param start The first date on or after which desired articles have occurred.
     * @param end The last date before which desired articles have occurred.
     ...
     *
     * @param text The text to search for or regex to match content against, for the desired article.
    ...
    /**
     * Export an Article model object, based on the above schema, with the above query functions.
     */
