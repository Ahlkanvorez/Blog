(function () {
     ...
     * The 'name' attribute is displayed in the browser as the title of the category, and the 'description' is displayed
     * below the name on the main page for viewing a category.
     * The 'aboutAuthor' attribute is used in the paragraph below the name of the category in the right-column of both
     ...
     *
     * @returns all the categories in the database which are public (not private).
     */
     ...
     *
     * @param name The name or regex to match against the name, of the desired categories.
    ...
    /**
     * Searches for categories whose description contains the provided pattern (regular expression).
     *
     * @param description The description or regex to match against the description, of the desired categories.
    ...
    /**
     * Export a Category model object, based on the above schema, with the above query functions.
     */
