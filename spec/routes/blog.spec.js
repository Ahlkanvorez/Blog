(function () {
    ...
    describe('Blog Server, Blog route', function () {
        ...
        describe('GET /all-article-list/:category', function () {
            it('returns status code 403', function (done) {
                request(base_url + '/all-article-list/Technology', function (err, res, data) {
                    expect(res.statusCode).toBe(403);
                    done();
                });
            });
        ...
        describe('GET /article-list/:category/:author', function () {
            ...
            it('returns status code 200', function (done) {
                request(base_url + '/article-list/' + category + '/' + author, function (err, res, data) {
                    expect(res.statusCode).toBe(200);
                    done();
                });
            });
        ...
        describe('GET /get-article/:id', function () {
            ...
            it("returns the 'The Making of my Blog' in JSON form", function (done) {
                request(base_url + '/get-article/57c6015189339c33682da923', function (err, res, data) {
        ...
        describe('POST /post-article', function () {
            it('returns status code 301 when not already logged in.', function (done) {
