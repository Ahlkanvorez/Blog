(function () {
    ...
    /** Define the 'articleList' module, which encapsulates the View and
     * Controller for pages which view a list of articles, by category name,
     * author name, between two dates, or some combination thereof.
     * - ngSanitize is needed in order to allow Angular to inject the HTML data
