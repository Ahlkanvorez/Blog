(function () {
     ...
     *  The REST API presented by this service allows HTTP GET, PUT, POST, and DELETE operations, since the admin will
     *     need to be able to view, edit, delete, and create new categories.
     *
     ...
     *  - updateCategory allows changes to an existing category to be made by ID, via a PUT request.
     *  - deleteCategory removes a category from the database by ID, via a DELETE request.
     *
     * Requirements:
